...
@TGXBOT.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@TGXBOT.on(admin_cmd(pattern="cos ?(.*)"))
@TGXBOT.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@TGXBOT.on(admin_cmd(pattern="tan ?(.*)"))
@TGXBOT.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@TGXBOT.on(admin_cmd(pattern="cosec ?(.*)"))
@TGXBOT.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@TGXBOT.on(admin_cmd(pattern="sec ?(.*)"))
@TGXBOT.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@TGXBOT.on(admin_cmd(pattern="cot ?(.*)"))
@TGXBOT.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@TGXBOT.on(admin_cmd(pattern="square ?(.*)"))
@TGXBOT.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@TGXBOT.on(admin_cmd(pattern="cube ?(.*)"))
@TGXBOT.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))

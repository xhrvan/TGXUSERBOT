...
LEGENDPIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://telegra.ph/file/b59e00c649f75fffbcd5d.jpg"
)
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
myid = bot.uid
...
USER_BOT_NO_WARN = (
    "**🔥 ƬɠӾẞø𝚝 Prîvã†é Sêçürïty Prø†öçõl 🔥**.\n\n"
    f"τнιѕ ιѕ мγ οωиєя {DEFAULTUSER}'s\n"
    f"\n**{LEGEND}**\n\n"
    "⚡яєgιѕτєя γουя яєգυєѕτ!⚡\nѕєи∂ `/start` το яєgιѕτєя γουя яєգυєѕτ🔥**"
)
